...
namespace SubastaYa.Servicios.Abstracciones
{
    ...
    public class Mediator : IMediator
    {
        ...
        public async Task<TResponse> Send<TResponse>(IRequest<TResponse> request)
        {
            ...
            // 2) Armamos el tipo de Handler que le corresponde a ESE request:
            //    IRequestHandler<CrearSubastaCommand, ResultadoCreacionDto>
            var handlerType = typeof(IRequestHandler<,>).MakeGenericType(requestType, typeof(TResponse));

            // 3) Le pedimos al contenedor de DI (Program.cs) la instancia
            //    de ese Handler concreto.
            ...
            // 4) Invocamos el método Handle(request) vía reflection, porque en
            //    este punto solo tenemos el tipo en tiempo de ejecución.
